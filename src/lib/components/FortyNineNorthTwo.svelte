...
<section 
  bind:this={container}
  class="relative bg-white h-screen overflow-hidden"
  style="--mouse-x: {mouseX}; --mouse-y: {mouseY};"
>
  <!-- Grid Container -->
  <div class="grid grid-cols-1 md:grid-cols-2 h-full max-w-7xl mx-auto">
    <!-- Texto Lado Izquierdo -->
    <div class="flex items-center justify-center p-8 relative">
      <div class="max-w-xl w-full">
        <p class="text-gray-500 text-xl mb-4 text-left md:text-left" style="font-family: Inter, sans-serif;">junto con</p>
        <h2 data-split-text="true" class="mobile-title" style="color:rgb(32, 3, 20);font-size:144px;position:absolute;font-family:Recklessneue, sans-serif;text-align:left;letter-spacing:-4.32px;font-weight:300;line-height:165.6px;margin-bottom:0px;">
          <span style="display: block; text-align: left; width: 100%;">
            <span style="display: inline-block; translate: none; rotate: none; scale: none; transform: translate(0%, 0px);">Alberto</span>
          </span>
        </h2>
        <h2 data-split-text="true" class="mobile-title" style="color:rgb(32, 3, 20);font-size:144px;position:absolute;font-family:Recklessneue, sans-serif;text-align:left;letter-spacing:-4.32px;font-weight:300;line-height:165.6px;margin-top:115.2px;">
          <span style="display: block; text-align: left; width: 100%;">
            <span style="display: inline-block; translate: none; rotate: none; scale: none; transform: translate(0%, 0px);">Maccioni</span>
          </span>
        </h2>
      </div>
    </div>
