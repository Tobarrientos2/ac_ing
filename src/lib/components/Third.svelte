<script>
    ...
    const data = {
        "ingenieria-estructural": {
            ...
            m_filters: ["Oficinas", "Hoteles", "Industria", "Entretenimiento"],
            m_selectedFilter: "Oficinas",
            m_filterContent: {
                "Oficinas": {
        ...
        "revision-ingenieria-estructural": {
            ...
            tp2: "Edificio GINO - Proyecto de ingeniería estructural",
            tp3: "FALTA INFORMACIÓN",
            tp4: "Edificio Santarita - Proyecto de ingeniería estructural",
        ...
        "desarrollo-sistemas-innovativos": {
            ...
            tg2: "Creación del sistema de entibación de taludes de excavación mediante tensores a terreno. Este sistema creado por AC Ingeniería Estructural se diseñó por primera vez en la obra del Hotel Sheraton San Cristóbal, siendo hoy en día masivamente utilizado en la construcción de edificios de varios subterráneos.",
        ...
        "eventos": {
            ...
            tp3: "© AC Proyectos y Asesorías | Partner: Universidad del Desarrollo y Copromet | Patrocinio: Embajada de Estados Unidos | 2006",
...
<div class="overflow-hidden antialiased bg-black font-lato pb-12 md:pb-16 lg:pb-24 z-40 relative">
            ...
            <div class="lg:col-span-8">
                <div class="prose max-w-none">
                    ...
                    <p class="text-lg leading-relaxed text-white mb-12 font-lato font-normal">
                        En AC Ingeniería Estructural ofrecemos una amplia gama de servicios especializados en ingeniería estructural, 
                        diseñados para satisfacer las necesidades específicas de cada proyecto y cliente.
                    </p>
                </div>
            </div>
        </div>
    ...
    {#each Object.entries(data) as [slug, service], index}
        <div class="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 mt-8 md:mt-12 {index > 0 ? 'pt-16 border-t border-gray-800' : ''}">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div class="prose max-w-none mb-8">
                        ...
                        {#if service.metadata_filters}
                            <div class="flex flex-wrap gap-4 mb-8">
                                <p class="text-lg leading-relaxed text-white font-lato font-normal flex items-center">Para</p>
                ...
                <!-- Right Image Section -->
                {#if service.metadata_filters}
                    <div class="lg:col-span-4 lg:border-l border-gray-800 lg:pl-8 mt-8 lg:mt-0">
                        <figure class="mb-8">
