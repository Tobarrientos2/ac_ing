...
<header class="fixed top-6 left-12 right-12 z-50">
  <nav class="px-6 py-6 flex justify-center items-center relative">
    <a href="/" class="z-50">
      <div class="w-[120px] opacity-90 hover:opacity-100 transition-opacity duration-300"> 
        <Logo />
      </div>
    </a>
    <!-- Comentado temporalmente
